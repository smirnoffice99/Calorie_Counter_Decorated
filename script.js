...
// Utility: File to Base64 with Resizing & Compression
function fileToBase64(file, maxWidth = 512, maxHeight = 512, quality = 0.7) {
    return new Promise((resolve, reject) => {
        ...
        reader.onload = (event) => {
            ...
            img.onload = () => {
                ...
                // 고화질 원본 대신 WebP 또는 JPEG 포맷으로 압축하여 Base64 생성
